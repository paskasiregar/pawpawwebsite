...
export const Hero = () => {
  return (
    <div className="w-full hero-bg font-plus-jakarta w-full max-w-none min-h-screen flex flex-col items-center justify-center p-8 md:p-20 relative bg-gradient-to-b from-purple-500 to-pink-500">
      <div className="w-full space-y-8 relative z-10 text-center md:text-left md:w-1/2">
        <svg
          width="207"
          height="25"
          viewBox="0 0 207 25"
        ...
        <div className="w-full flex flex-col items-start justify-start space-y-12">
          <div className="w-full flex flex-col items-start justify-start gap-y-4">
            <div className="w-full self-stretch text-8xl md:text-6xl font-extrabold">
              More than just pets...
            </div>
