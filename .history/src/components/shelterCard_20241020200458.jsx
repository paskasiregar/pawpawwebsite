      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          <div className="flex justify-between items-center mb-2">
            <span className="text-xs font-bold text-purple-500 uppercase bg-purple-200 px-2 py-1 rounded-full">
              {type}
            </span>
          </div>
          ...
          <Link href={instagramUrl} passHref>
            ...
            >
              <Image
                ...
                height={20}
              />
              <span className="ml-2 text-purple-700">Visit Instagram</span>
            </a>
          </Link>
        </div>
      </div>
