...
import linkedin from "../assets/linkedin.webp"; // confirm path
import github from "../assets/github.png"; // confirm path
import website from "../assets/website.png"; // confirm path
