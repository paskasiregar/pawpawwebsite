...
export const Contact = () => {
  return (
    <div className="font-plus-jakarta flex flex-col items-center justify-center py-8 px-4 md:py-16 md:px-[200px] gap-8 md:gap-[40px] text-29xl">
      ...
      <div className="w-full flex flex-col items-start gap-4 md:gap-[16px] text-base text-light-l800 font-regular-reg-2">
