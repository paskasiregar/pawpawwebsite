...
export const Hero = () => {
  return (
    <div className="hero-bg font-plus-jakarta w-full max-w-none min-h-screen flex flex-col items-center justify-center p-8 md:p-20 relative bg-gradient-to-b from-purple-500 to-pink-500">
