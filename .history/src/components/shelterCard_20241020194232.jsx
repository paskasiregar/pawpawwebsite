...
import locationIcon from "../assets/location.png"; // Make sure to have a location icon image
import instagramIcon from "../assets/instagram.png"; // Make sure to have an Instagram icon image
      ...
      <div className="p-4">
        ...
        <div className="mt-4">
          <Link href={instagramUrl} passHref>
            <a
              className="flex items-center justify-center border border-purple-500 rounded-md py-2 px-4 hover:bg-purple-100 transition duration-200"
              target="_blank"
