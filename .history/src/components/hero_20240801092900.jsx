  ...
  return (
    <div className="gap-8 hero-bg font-plus-jakarta w-full flex flex-col md:flex-row items-center justify-center p-8 md:p-20 relative">
      ...
      <div>
        {/* content */}
        {/* Happy Homes */}
        <div className="mt-10 flex flex-col items-center md:items-start justify-center z-[2] text-xl w-full px-4 md:px-0 space-y-8">
          <div className="w-full flex flex-col items-start justify-start gap-4 md:gap-6">
            <div className="w-full flex flex-col items-start justify-start space-y-8">
              <div className="w-full rounded-xl bg-white flex flex-row items-center justify-start p-5 gap-4 md:gap-6 space-y-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2em"
                  height="2em"
                ...
                <div className="flex-1 flex flex-col items-start justify-start gap-2">
                  ...
                  <div className="self-stretch relative text-sm md:text-base leading-snug text-dark-d200">
                    Every game you play helps provide safe shelters for stray
                    cats and dogs.
                  </div>
                </div>
              </div>
            ...
            <div className="w-full flex flex-col items-start justify-start">
              <div className="w-full rounded-xl bg-white flex flex-row items-center justify-start p-5 gap-4 md:gap-6">
                ...
                <div className="flex-1 flex flex-col items-start justify-start gap-2">
                  ...
                  <div className="self-stretch relative text-sm md:text-base leading-snug text-dark-d200">
                    Ensure every stray pet gets nutritious meals by simply
                    playing the game.
                  </div>
                </div>
              </div>
