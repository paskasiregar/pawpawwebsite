    ...
    <div className="w-full font-plus-jakarta m-auto flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="w-full">
        ...
        <main className="main-container">
          ...
          {/* How it works section with CSS animation */}
          <div
            id="how-it-works"
            className="flex-1 flex flex-col items-center md:items-start justify-center gap-4 z-[1] p-4 md:p-8 animate-fade-in-up"
          >
                ...
                <div className="flex-1 flex flex-col items-center md:items-start justify-start">
                  <div className="self-stretch">
                    <p className="m-0 text-center md:text-left">
                      Every video you watch on our app can help animals in need.
                      Fun, isn&apos;t it?
                    </p>
                    <p className="m-2"></p>
                    <p className="m-0 text-center md:text-left">
                      Join us at PawPaw Portal, where animal lovers and shelters
                      meet. Let&apos;s make a difference together!
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Team section with CSS animation */}
          <Divider />
          <div
            id="team"
            className="flex-1 flex flex-col items-center md:items-center justify-center gap-4 z-[1] p-4 md:p-8 animate-fade-in-up"
          >
