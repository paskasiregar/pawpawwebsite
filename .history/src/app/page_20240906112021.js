        ...
        <main className="main-container">
          ...
          <div className="self-stretch bg-white flex flex-col md:flex-row">
            ...
            >
              <div className="space-y-4">
                <div className="flex flex-col items-center md:items-start">
                  <div className="relative font-extrabold text-2xl md:text-4xl text-center md:text-center">
                    PawPaw Team
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                  ...
                  <div className="flex flex-col items-center">
                    <Image
                      ...
                      alt="Team Member 1"
                      src="/assets/piupiu.png"
                      width={150}
                      height={150}
                    />
                    <div className="text-xl font-semibold mt-4">John Doe</div>
                  ...
                  <div className="flex flex-col items-center">
                    <Image
                      ...
                      height={150}
                    />
                    <div className="text-xl font-semibold mt-4">Jane Smith</div>
                    <div className="text-gray-500">CTO</div>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="text-gray-500">Marketing Head</div>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <Image
                      className="rounded-full"
                      alt="Team Member 4"
                      src="/path-to-team-member-4.jpg"
                      width={150}
                      height={150}
                    />
                    <div className="text-xl font-semibold mt-4">Lisa Brown</div>
                ...
                <div className="self-stretch flex flex-col md:flex-row items-center md:items-start justify-start text-lg md:text-xl text-gray-500">
                  <div className="flex-1 flex flex-col items-center md:items-start justify-start">
                    <div className="self-stretch">
                      <p className="m-2"></p>
                      <p className="m-20 text-center md:text-center">
                        Our team is passionately driven to give strays a second
                        chance, pouring heart and hustle into every step to help
