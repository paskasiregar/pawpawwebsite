      ...
      <section className="w-full">
        ...
        <main className="main-container">
          ...
          <div className="self-stretch bg-white flex flex-col md:flex-row">
            <div
              id="team"
              className="flex-1 flex flex-col items-center md:items-center justify-center gap-4 z-[1] p-4 md:p-8 mb-8"
            >
              <div className="space-y-4">
                <div className="flex flex-col items-center md:items-center ">
                  <div className="relative font-extrabold text-2xl md:text-4xl text-center">
                    PawPaw Team
                  </div>
