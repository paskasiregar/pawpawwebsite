...
export default async function Home() {
  return (
    <div className="mt-20 mb-0 w-full font-plus-jakarta m-auto flex min-h-screen flex-col items-center justify-between">
      <Head>
        <script
          async
            ...
            <div className="space-y-4 justify-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 justify-center">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-gray-500">Founders Office</div>
                  <Link
