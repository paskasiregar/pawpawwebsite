...
export default async function Privacy() {
  return (
    <div className="w-full font-plus-jakarta mx-auto flex flex-col items-center justify-between min-h-screen my-20">
          ...
          <div className="container mx-auto p-4">
            ...
            <section>
              ...
              <p className="text-sm md:text-base">
                ...
                contact us at{" "}
                <Link href="mailto:hi@pawpawportal.com">
                  <strong>hi@pawpawportal.com</strong>
                </Link>
                .
              </p>
            </section>
