      ...
      <section className="w-full">
        <div className="w-full">
          ...
          <div className="container mx-auto p-4">
            <div className="text-black text-4xl font-extrabold my-4">
              Privacy Policy
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-4">
                <p className="text-med text-gray-800 mb-4">
            ...
            <p className="mb-10 text-gray-600">Last updated: [6 Sept 2024]</p>
