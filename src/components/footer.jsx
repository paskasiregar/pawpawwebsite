...
export const Footer = () => {
  return (
    <div className="font-plus-jakarta w-full flex bg-black py-8">
        ...
        <div className="text-gray-300 space-y-6">
          <div className="flex flex-col items-start mb-6">
            ...
            <div className="space-y-4">
              ...
              />
              <div className="space-y-4">
                <div className="text-white text-3xl font-extrabold justify-start items-start">
                  PawPaw Portal
                </div>
            ...
            <div className="flex mt-4">
              <div className="space-y-2">
                <div className="font-semibold text-xl">Our Vision</div>
              ...
              <div className="space-y-2">
                <div className="font-semibold text-xl">Our Mission</div>
                <div className="text-xs text-gray-500">
                  <ol>
                    <li>
            ...
            {/* social media */}
            <div className="text-xl font-semibold mb-4">Stay in touch</div>
