...
export const Hero = () => {
  return (
    <div className="hero-bg font-plus-jakarta w-full flex flex-row items-center justify-center p-20 relative">
      <div className="space-y-8 relative z-10">
        ...
        <div className="flex-1 flex flex-col items-start justify-start space-y-12">
          <div className="flex flex-col items-start justify-start gap-y-4">
            <div className="self-stretch text-6xl font-extrabold">
              More than just pets...
            </div>
      ...
      <div className="flex flex-col items-start justify-center z-[2] text-xl">
        <div className="w-[488px] flex flex-col items-start justify-start gap-[20px]">
          <div className="self-stretch flex flex-col items-start justify-start">
            <div className="w-[460px] rounded-xl bg-white flex flex-row items-center justify-start p-5 box-border gap-[12px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="2em"
                height="2em"
              ...
              <div className="flex-1 flex flex-col items-start justify-start gap-[4px]">
                ...
                <div className="self-stretch relative text-base leading-[120%] font-regular-reg-2 text-dark-d200">
